...
public class UtilsTest {
    ...
    public void testArray() {
        ...
        fory.registerSerializerAndType(Array.class, new ArraySerializer(fory));
    ...
    public void testSnapshotArray() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(SnapshotArray.class, new SnapshotArraySerializer(fory));
    ...
    public void testDelayedRemovalArray() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(DelayedRemovalArray.class, new DelayedRemovalArraySerializer(fory));
    ...
    public void testArrayMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ArrayMap.class, new ArrayMapSerializer(fory));
    ...
    public void testQueue() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Queue.class, new QueueSerializer(fory));
    ...
    public void testObjectSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectSet.class, new ObjectSetSerializer(fory));
    ...
    public void testOrderedSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(OrderedSet.class, new OrderedSetSerializer(fory));
    ...
    public void testObjectMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectMap.class, new ObjectMapSerializer(fory));
    ...
    public void testOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(OrderedMap.class, new OrderedMapSerializer(fory));
    ...
    public void testBooleanArray() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(BooleanArray.class, new BooleanArraySerializer(fory));
    ...
    public void testByteArray() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ByteArray.class, new ByteArraySerializer(fory));
    ...
    public void testCharArray() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(CharArray.class, new CharArraySerializer(fory));
    ...
    public void testFloatArray() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(FloatArray.class, new FloatArraySerializer(fory));
    ...
    public void testIntArray() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntArray.class, new IntArraySerializer(fory));
    ...
    public void testIntSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntSet.class, new IntSetSerializer(fory));
    ...
    public void testIntMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntMap.class, new IntMapSerializer(fory));
    ...
    public void testLongArray() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongArray.class, new LongArraySerializer(fory));
    ...
    public void testLongQueue() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongQueue.class, new LongQueueSerializer(fory));
    ...
    public void testLongSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongSet.class, new LongSetSerializer(fory));
    ...
    public void testLongMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongMap.class, new LongMapSerializer(fory));
    ...
    public void testShortArray() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ShortArray.class, new ShortArraySerializer(fory));
