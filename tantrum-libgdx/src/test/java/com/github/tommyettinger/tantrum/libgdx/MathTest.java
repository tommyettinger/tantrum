...
public class MathTest {
    ...
    public void testGridPoint2() {
        ...
        fory.registerSerializerAndType(GridPoint2.class, new GridPoint2Serializer(fory));
    ...
    public void testGridPoint3() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(GridPoint3.class, new GridPoint3Serializer(fory));
    ...
    public void testVector2() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Vector2.class, new Vector2Serializer(fory));
    ...
    public void testVector3() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Vector3.class, new Vector3Serializer(fory));
    ...
    public void testVector4() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Vector4.class, new Vector4Serializer(fory));
    ...
    public void testQuaternion() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Quaternion.class, new QuaternionSerializer(fory));
    ...
    public void testEllipse() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Ellipse.class, new EllipseSerializer(fory));
...
//            Assert.assertEquals(data, data2);
    ...
    public void testRectangle() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Rectangle.class, new RectangleSerializer(fory));
    ...
    public void testCircle() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Circle.class, new CircleSerializer(fory));
    ...
    public void testPlane() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Plane.class, new PlaneSerializer(fory));
...
//            Assert.assertEquals(data, data2);
    ...
    public void testRandomXS128() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(RandomXS128.class, new RandomXS128Serializer(fory));
...
//        Assert.assertEquals(data, data2);
    ...
    public void testMatrix3() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Matrix3.class, new Matrix3Serializer(fory));
...
//        Assert.assertEquals(data, data2);
    ...
    public void testMatrix4() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Matrix4.class, new Matrix4Serializer(fory));
...
//        Assert.assertEquals(data, data2);
    ...
    public void testAffine2() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Affine2.class, new Affine2Serializer(fory));
...
//        Assert.assertEquals(data, data2);
    ...
    public void testPolygon() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Polygon.class, new PolygonSerializer(fory));
...
//            Assert.assertEquals(data, data2);
    ...
    public void testPolyline() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Polyline.class, new PolylineSerializer(fory));
...
//            Assert.assertEquals(data, data2);
    ...
    public void testRay() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Ray.class, new RaySerializer(fory));
    ...
    public void testBoundingBox() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(BoundingBox.class, new BoundingBoxSerializer(fory));
...
//                Assert.assertEquals(data, data2);
    ...
    public void testOrientedBoundingBox() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(OrientedBoundingBox.class, new OrientedBoundingBoxSerializer(fory));
...
//        Assert.assertEquals(data, data2);
    ...
    public void testColor() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Color.class, new ColorSerializer(fory));
