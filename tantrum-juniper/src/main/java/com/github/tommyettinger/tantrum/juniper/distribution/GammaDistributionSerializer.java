...
public class GammaDistributionSerializer extends Serializer<GammaDistribution> {
    ...
    @Override
    public void write(final MemoryBuffer output, GammaDistribution object) {
    ...
    @Override
    public GammaDistribution read(MemoryBuffer input) {
        return new GammaDistribution((EnhancedRandom) fury.readRef(input),
