...
public class WeibullDistributionSerializer extends Serializer<WeibullDistribution> {
    ...
    @Override
    public void write(final MemoryBuffer output, WeibullDistribution object) {
    ...
    @Override
    public WeibullDistribution read(MemoryBuffer input) {
        return new WeibullDistribution((EnhancedRandom) fury.readRef(input),
