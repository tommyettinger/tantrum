...
public class FisherSnedecorDistributionSerializer extends Serializer<FisherSnedecorDistribution> {
    ...
    @Override
    public void write(final MemoryBuffer output, FisherSnedecorDistribution object) {
    ...
    @Override
    public FisherSnedecorDistribution read(MemoryBuffer input) {
        return new FisherSnedecorDistribution((EnhancedRandom) fury.readRef(input),
