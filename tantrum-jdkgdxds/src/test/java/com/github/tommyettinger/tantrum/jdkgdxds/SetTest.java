...
public class SetTest {
    ...
    public void testIntOrderedSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntOrderedSet.class, new IntOrderedSetSerializer(fory));
    ...
    public void testLongOrderedSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongOrderedSet.class, new LongOrderedSetSerializer(fory));
    ...
    public void testObjectOrderedSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectOrderedSet.class, new ObjectOrderedSetSerializer(fory));
    ...
    public void testCaseInsensitiveSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(CaseInsensitiveSet.class, new CaseInsensitiveSetSerializer(fory));
    ...
    public void testCaseInsensitiveOrderedSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(CaseInsensitiveOrderedSet.class, new CaseInsensitiveOrderedSetSerializer(fory));
    ...
    public void testOffsetBitSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(OffsetBitSet.class, new OffsetBitSetSerializer(fory));
    ...
    public void testCharBitSet() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(CharBitSet.class, new CharBitSetSerializer(fory));
    ...
    public void testCharBitSetFixedSize() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(CharBitSetFixedSize.class, new CharBitSetFixedSizeSerializer(fory));
...
//        fory.registerSerializerAndType(HolderSet.class, new HolderSetSerializer(fory));
//
...
//        kryo.register(String.class);
//        kryo.register(ObjToObjFunction.class);
//        fory.registerSerializerAndType(HolderOrderedSet.class, new HolderOrderedSetSerializer(fory));
//
//        ObjToObjFunction<String, String> f = s -> s.split("\\s+")[0];
...
//
    ...
    public void testFilteredStringSet() {
        ...
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(FilteredStringSet.class, new FilteredStringSetSerializer(fory));
    ...
    public void testFilteredStringOrderedSet() {
        ...
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(FilteredStringOrderedSet.class, new FilteredStringOrderedSetSerializer(fory));
    ...
    public void testEnumSet() {
        ...
        fory.registerSerializerAndType(EnumSet.class, new EnumSetSerializer(fory));
    ...
    public void testEnumOrderedSet() {
        ...
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.register(Character.UnicodeScript.class);
        fory.registerSerializerAndType(EnumOrderedSet.class, new EnumOrderedSetSerializer(fory));
...
//        fory.registerSerializerAndType(FilteredIterableSet.class, new FilteredIterableSetSerializer(fory));
//
...
//        fory.register(ObjToSameFunction.class);
//        fory.registerSerializerAndType(ObjectList.class, new ObjectListSerializer(fory));
//        fory.registerSerializerAndType(FilteredIterableOrderedSet.class, new FilteredIterableOrderedSetSerializer(fory));
//
