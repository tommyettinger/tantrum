...
public class DequeTest {
    ...
    public void testLongDeque() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongDeque.class, new LongDequeSerializer(fory));
    ...
    public void testShortDeque() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ShortDeque.class, new ShortDequeSerializer(fory));
    ...
    public void testByteDeque() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ByteDeque.class, new ByteDequeSerializer(fory));
    ...
    public void testFloatDeque() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(FloatDeque.class, new FloatDequeSerializer(fory));
    ...
    public void testDoubleDeque() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(DoubleDeque.class, new DoubleDequeSerializer(fory));
    ...
    public void testBooleanDeque() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(BooleanDeque.class, new BooleanDequeSerializer(fory));
    ...
    public void testCharDeque() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(CharDeque.class, new CharDequeSerializer(fory));
