...
public class MapTest {
    ...
    public void testLongObjectMap() {
        ...
        fory.registerSerializerAndType(LongObjectMap.class, new LongObjectMapSerializer(fory));
    ...
    public void testLongObjectOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongObjectOrderedMap.class, new LongObjectOrderedMapSerializer(fory));
    ...
    public void testLongFloatMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongFloatMap.class, new LongFloatMapSerializer(fory));
    ...
    public void testLongFloatOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongFloatOrderedMap.class, new LongFloatOrderedMapSerializer(fory));
    ...
    public void testLongIntMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongIntMap.class, new LongIntMapSerializer(fory));
    ...
    public void testLongIntOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongIntOrderedMap.class, new LongIntOrderedMapSerializer(fory));
    ...
    public void testLongLongMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongLongMap.class, new LongLongMapSerializer(fory));
    ...
    public void testLongLongOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(LongLongOrderedMap.class, new LongLongOrderedMapSerializer(fory));
    ...
    public void testIntObjectMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntObjectMap.class, new IntObjectMapSerializer(fory));
    ...
    public void testIntFloatMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntFloatMap.class, new IntFloatMapSerializer(fory));
    ...
    public void testIntFloatOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntFloatOrderedMap.class, new IntFloatOrderedMapSerializer(fory));
    ...
    public void testIntIntMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntIntMap.class, new IntIntMapSerializer(fory));
    ...
    public void testIntIntOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntIntOrderedMap.class, new IntIntOrderedMapSerializer(fory));
    ...
    public void testIntLongMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntLongMap.class, new IntLongMapSerializer(fory));
    ...
    public void testIntLongOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(IntLongOrderedMap.class, new IntLongOrderedMapSerializer(fory));
    ...
    public void testObjectObjectMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectObjectMap.class, new ObjectObjectMapSerializer(fory));
    ...
    public void testObjectObjectOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectObjectOrderedMap.class, new ObjectObjectOrderedMapSerializer(fory));
    ...
    public void testObjectIntMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectIntMap.class, new ObjectIntMapSerializer(fory));
    ...
    public void testObjectIntOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectIntOrderedMap.class, new ObjectIntOrderedMapSerializer(fory));
    ...
    public void testObjectLongMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectLongMap.class, new ObjectLongMapSerializer(fory));
    ...
    public void testObjectLongOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectLongOrderedMap.class, new ObjectLongOrderedMapSerializer(fory));
    ...
    public void testObjectFloatMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectFloatMap.class, new ObjectFloatMapSerializer(fory));
    ...
    public void testObjectFloatOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(ObjectFloatOrderedMap.class, new ObjectFloatOrderedMapSerializer(fory));
    ...
    public void testCaseInsensitiveMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(CaseInsensitiveMap.class, new CaseInsensitiveMapSerializer(fory));
    ...
    public void testCaseInsensitiveOrderedMap() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(CaseInsensitiveOrderedMap.class, new CaseInsensitiveOrderedMapSerializer(fory));
    ...
    public void testFilteredStringMap() {
        ...
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(FilteredStringMap.class, new FilteredStringMapSerializer(fory));
    ...
    public void testFilteredStringOrderedMap() {
        ...
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(FilteredStringOrderedMap.class, new FilteredStringOrderedMapSerializer(fory));
    ...
    public void testEnumMap() {
        ...
        fory.registerSerializerAndType(EnumMap.class, new EnumMapSerializer(fory));
    ...
    public void testEnumOrderedMap() {
        ...
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.register(Character.UnicodeScript.class);
        fory.registerSerializerAndType(EnumOrderedMap.class, new EnumOrderedMapSerializer(fory));
    ...
    public void testEnumIntMap() {
        ...
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.register(Character.UnicodeScript.class);
        fory.registerSerializerAndType(EnumIntMap.class, new EnumIntMapSerializer(fory));
    ...
    public void testEnumIntOrderedMap() {
        ...
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.register(Character.UnicodeScript.class);
        fory.registerSerializerAndType(EnumIntOrderedMap.class, new EnumIntOrderedMapSerializer(fory));
    ...
    public void testEnumLongMap() {
        ...
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.register(Character.UnicodeScript.class);
        fory.registerSerializerAndType(EnumLongMap.class, new EnumLongMapSerializer(fory));
    ...
    public void testEnumLongOrderedMap() {
        ...
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.register(Character.UnicodeScript.class);
        fory.registerSerializerAndType(EnumLongOrderedMap.class, new EnumLongOrderedMapSerializer(fory));
    ...
    public void testEnumFloatMap() {
        ...
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.register(Character.UnicodeScript.class);
        fory.registerSerializerAndType(EnumFloatMap.class, new EnumFloatMapSerializer(fory));
    ...
    public void testEnumFloatOrderedMap() {
        ...
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.register(Character.UnicodeScript.class);
        fory.registerSerializerAndType(EnumFloatOrderedMap.class, new EnumFloatOrderedMapSerializer(fory));
...
//        fory.registerSerializerAndType(FilteredIterableMap.class, new FilteredIterableMapSerializer(fory));
//
...
//        kryo.register(ObjToSameFunction.class);
//        fory.registerSerializerAndType(ObjectList.class, new ObjectListSerializer(fory));
//        fory.registerSerializerAndType(FilteredIterableOrderedMap.class, new FilteredIterableOrderedMapSerializer(fory));
//
