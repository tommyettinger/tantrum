...
/**
 * Fury {@link Serializer} for jdkgdxds {@link IntList}s.
 */
public class IntListSerializer extends Serializer<IntList> {

    public IntListSerializer(Fury fury) {
        super(fury, IntList.class);
    }
    ...
    public IntList read(MemoryBuffer input) {
        return new IntList(Support.readIntsWithSizeEmbedded(input));
    }
}