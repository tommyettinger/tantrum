...
or if Fory itself had a (compatible) update available but the linked library did not have an update.
  ...
  - tantrum-libgdx is at version 1.14.0.22, compatible with libGDX 1.14.0
  - tantrum-digital is at version 0.10.0.22, compatible with digital 0.10.0
...
The current version of libGDX at the time of writing is 1.14.0, which works with Fory 0.16.0 via tantrum-libgdx
1.14.0.22 . The older libGDX version 1.13.5 works with Fury (not Fory) 0.10.2 via tantrum-libgdx 1.13.5.8 .
...
```gradle
implementation "com.github.tommyettinger:tantrum-libgdx:1.14.0.22"
```

tantrum-digital:

```gradle
implementation "com.github.tommyettinger:tantrum-digital:0.10.0.22"
```
