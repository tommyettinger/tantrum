...
or if Fory itself had a (compatible) update available but the linked library did not have an update.
  ...
  - tantrum-libgdx is at version 1.14.1.26, compatible with libGDX 1.14.1
  - tantrum-digital is at version 0.10.0.26, compatible with digital 0.10.0
  - tantrum-jdkgdxds is at version 2.1.3.26, compatible with jdkgdxds 2.1.3
...
The current version of libGDX at the time of writing is 1.14.1, which works with Fory 1.1.0 via tantrum-libgdx
1.14.1.26 . The earlier 1.14.0 release works with tantrum-libgdx 1.14.0.24 and Fory 0.17.0.
...
```gradle
implementation "com.github.tommyettinger:tantrum-libgdx:1.14.1.26"
```
...
```gradle
implementation "com.github.tommyettinger:tantrum-jdkgdxds:2.1.3.26"
```
