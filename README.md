...
or if Fury itself had a (compatible) update available but the linked library did not have an update.
  ...
  - tantrum-regexodus is at version 0.1.18.7, compatible with RegExodus 0.1.18
...
```gradle
implementation "com.github.tommyettinger:tantrum-regexodus:0.1.18.7"
```
