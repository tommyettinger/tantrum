...
This lets [Fory](https://fory.apache.org) (currently 0.12.0) de/serialize objects from [libGDX](https://libgdx.com)
...
or if Fory itself had a (compatible) update available but the linked library did not have an update.
  ...
  - tantrum-digital is at version 0.9.1.12, compatible with digital 0.9.1
...
```gradle
implementation "com.github.tommyettinger:tantrum-libgdx:1.13.1.13"
```

tantrum-digital:

```gradle
implementation "com.github.tommyettinger:tantrum-digital:0.9.1.12"
```
...
```gradle
implementation "com.github.tommyettinger:tantrum-regexodus:0.1.19.13"
```
