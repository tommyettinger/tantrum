...
or if Fory itself had a (compatible) update available but the linked library did not have an update.
  ...
  - tantrum-digital is at version 0.8.1.12, compatible with digital 0.8.1
...
```gradle
implementation "com.github.tommyettinger:tantrum-digital:0.8.1.12"
```
