...
This lets [Fory](https://fory.apache.org) (currently 1.0.0) de/serialize objects from [libGDX](https://libgdx.com)
...
or if Fory itself had a (compatible) update available but the linked library did not have an update.
  ...
  - tantrum-digital is at version 0.10.0.25, compatible with digital 0.10.0
  - tantrum-jdkgdxds is at version 2.1.3.25, compatible with jdkgdxds 2.1.3
  - tantrum-regexodus is at version 0.1.21.25, compatible with RegExodus 0.1.21
...
```gradle
implementation "com.github.tommyettinger:tantrum-digital:0.10.0.25"
```

tantrum-jdkgdxds:

```gradle
implementation "com.github.tommyettinger:tantrum-jdkgdxds:2.1.3.25"
```

tantrum-regexodus:

```gradle
implementation "com.github.tommyettinger:tantrum-regexodus:0.1.21.25"
```
