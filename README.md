...
or if Fory itself had a (compatible) update available but the linked library did not have an update.
  ...
  - tantrum-libgdx is at version 1.14.0.23, compatible with libGDX 1.14.0
  - tantrum-digital is at version 0.10.0.23, compatible with digital 0.10.0
  - tantrum-jdkgdxds is at version 2.1.2.23, compatible with jdkgdxds 2.1.2
  - tantrum-regexodus is at version 0.1.21.23, compatible with RegExodus 0.1.21
...
The current version of libGDX at the time of writing is 1.14.0, which works with Fory 0.17.0 via tantrum-libgdx
1.14.0.23 . The older libGDX version 1.13.5 works with Fury (not Fory) 0.10.2 via tantrum-libgdx 1.13.5.8 .
...
```gradle
implementation "com.github.tommyettinger:tantrum-libgdx:1.14.0.23"
```

tantrum-digital:

```gradle
implementation "com.github.tommyettinger:tantrum-digital:0.10.0.23"
```

tantrum-jdkgdxds:

```gradle
implementation "com.github.tommyettinger:tantrum-jdkgdxds:2.1.2.23"
```

tantrum-regexodus:

```gradle
implementation "com.github.tommyettinger:tantrum-regexodus:0.1.21.23"
```
