...
public class DigitalTest {
    ...
    public void testBase() {
        ...
        fory.registerSerializerAndType(Base.class, new BaseSerializer(fory));
    ...
    public void testAlternateRandom() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(AlternateRandom.class, new AlternateRandomSerializer(fory));
    ...
    public void testHasher() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Hasher.class, new HasherSerializer(fory));
    ...
    public void testInterpolator() {
        LoggerFactory.disableLogging();
        Fory fory = Fory.builder().withLanguage(Language.JAVA).build();
        fory.registerSerializerAndType(Interpolations.Interpolator.class, new InterpolatorSerializer(fory));
